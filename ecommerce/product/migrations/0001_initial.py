# Generated by Django 3.0.10 on 2022-04-02 18:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_in_stock', models.IntegerField(blank=True, null=True, verbose_name='Count')),
                ('rating', models.FloatField(blank=True, null=True, verbose_name='Rating')),
                ('num_reviews', models.IntegerField(blank=True, null=True, verbose_name='Num Reviews')),
            ],
            options={
                'abstract': False,
            },
