...
from ecommerce.order.views import OrderCreateView, OrderDetailView, OrderListView, OrderAdminView
...
urlpatterns = [
    ...
    path('user/list/', view=OrderListView.as_view(), name='user_order_list'),
]